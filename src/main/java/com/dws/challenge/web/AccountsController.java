...
public class AccountsController {
  ...
  public ResponseEntity<Object> createAccount(@RequestBody @Valid Account account) {
    ...
    } catch (DuplicateAccountIdException | InvalidAccountException | InsufficientBalanceException daie) {
  ...
  public ResponseEntity<Object> transferMoney(
          @RequestBody @NotNull @Valid TransferRequest transferRequest) {
    log.info("Transferring money from {} to {} with amount {}",
